...
%token DEFAULT CASE DOOD DO OD PRINTCOMP
%token SCOPY DCOPY
%token LITERAL
...
Expr            :	LValue
                ...
                |	'(' CLASS IDENTIFIER ')' Expr
                	...
                	|	CASE '(' Expr ')' '{' CaseStmtList DefaultStmt '}'
                	{
                		$$.expr = new Tree.CaseExpr($3.expr, $6.slist, $7.stmt, $1.loc);
                	}
                	|	DCOPY '(' Expr ')'
                	{
...
CaseStmt			:   Constant ':' Expr ';'
					{
						$$.stmt=new Tree.CaseStmt($1.expr,$3.expr,$1.loc);
					}
				;

DefaultStmt		:	DEFAULT ':' Expr ';'
					{
						$$.stmt=new Tree.DefaultStmt($3.expr,$1.loc);
					}
				;
...
PrintCompStmt	: 	PRINTCOMP '(' ExprList ')'
				{
					$$.stmt = new Tree.PrintCompStmt($3.elist, $1.loc);
				}
