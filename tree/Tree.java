...
import decaf.tree.Tree.DcopyExpr;
...
import decaf.tree.Tree.PrintCompStmt;
...
public abstract class Tree {
    ...
    public static final int DEFAULTSTMT=WHILELOOP+1;
	
	public static final int CASESTMT=DEFAULTSTMT+1;
	
	public static final int CASEEXPR=CASESTMT+1;
    
	public static final int DOSUBSTMT=CASEEXPR+1;
	
	public static final int DOSTMT=DOSUBSTMT+1;
    /**
     * For-loops, of type ForLoop.
     */
    public static final int FORLOOP = DOSTMT + 1;
    ...
    public static final int PRINTCOMPSTMT = PRINT +1;
    ...
    public abstract static class Expr extends Tree {
    	...
    	public boolean copy,call,Super,nopar;
    ...
    public static class PrintCompStmt extends Tree {

    	public List<Expr> exprs;

    	public PrintCompStmt(List<Expr> exprs, Location loc) {
    		super(PRINTCOMPSTMT, loc);
    		this.exprs = exprs;
    	}

        @Override
        public void accept(Visitor v) {
            v.visitPrintCompStmt(this);
        }
    ...
    public static class DoStmt extends Tree {
		...
		public DoStmt(List<Tree> caseList, Location loc)
		{
			super(DOSTMT,loc);
		...
		public DoSubStmt(Expr condition,Tree loopBody, Location loc)
		{
			super(DOSUBSTMT,loc);
			this.condition=condition;
			this.loopBody=loopBody;
    	...
    	public static class DefaultStmt extends Tree {
    		
    		public Expr Expr1;
    		
    		public DefaultStmt(Expr Expr1,Location loc)
    		{
    			super(DEFAULTSTMT,loc);
    			this.Expr1=Expr1;
    		}
    	...
    	public static class CaseStmt extends Tree {
    		...
    		public CaseStmt(Expr constant,Expr Expr1,Location loc)
    		{
    			super(CASESTMT,loc);
    	...
    	public static class CaseExpr extends Expr {
    		...
    		public CaseExpr(Expr expr, List<Tree> caseList, Tree defaultStmt, Location loc)
    		{
    			super(CASEEXPR, loc);
    			this.expr=expr;
                this.caseList = caseList;
    ...
    public static abstract class Visitor {
        ...
        public void visitDefaultStmt(DefaultStmt that) {
            visitTree(that);
        }
		...
		public void visitPrintCompStmt(PrintCompStmt that) {
			visitTree(that);
		}
    }
}
